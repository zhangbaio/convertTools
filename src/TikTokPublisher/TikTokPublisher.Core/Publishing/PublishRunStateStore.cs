...
/// 持久化到 %LocalAppData%/TikTokPublisher/publish-run-state.json。</summary>
public sealed class PublishRunStateStore
{
    ...
    private static string FilePath => Path.Combine(AppPaths.DataRoot, "tiktok-publish-run-state.json");
