        ...
        WorkspaceBindingService.WorkspaceBinding? binding = null)
    {
        var item = persisted is null
            ...
            : new QueueProjectItem
            {
                ...
                LiveActionClassification = persisted.LiveActionClassification,
                LiveActionConfidence = persisted.LiveActionConfidence,
                LiveActionDetectionReason = persisted.LiveActionDetectionReason,
                LiveActionDetectedAt = persisted.LiveActionDetectedAt,
                LiveActionVideoFingerprint = persisted.LiveActionVideoFingerprint,
                PipelineExcluded = persisted.PipelineExcluded,
