...
public sealed class TikTokPublishDefaultsTests
{
    ...
    [Fact]
    public void Copyright_material_types_allow_empty_or_any_single_supported_value()
    {
        ...
        TikTokPublishConstants.ValidateCopyrightMaterialTypes([])
            .Should().BeEmpty();
        TikTokPublishConstants.ValidateCopyrightMaterialTypes(["filing_or_distribution_license"])
            .Should().Equal("filing_or_distribution_license");
    ...
    [Fact]
    public void Empty_material_selection_does_not_require_proof_generation()
    {
        TikTokPublishConstants.RequiresGeneratedProofMaterial([]).Should().BeFalse();
        TikTokPublishConstants.RequiresAutoGeneratedCopyrightMaterial([]).Should().BeFalse();
    }
